...
/// new class that derives from this and adds four <c>[Benchmark]</c> methods — one per library, Dormant the
/// baseline (FR-011). Override <see cref="GlobalSetup"/> (calling <c>base</c>) only if the operation needs
/// extra preparation, as the delete benchmark does for its key pool.
/// </summary>
